    ...
    render() {
        return (
            <div className="page-content">
                <h2>Work</h2>
                <p>
                    I started at Astronautics as a Software Engineer in June 2021. I currently work on the <a href="https://www.astronautics.com/products/connected-aircraft-solutions/aerosync/">AeroSync</a> product line
                    of connectivity avionics equipment. My work primarily consists of C programming for an embedded Linux platform,
                    maintaining React and Electron applications, and Python scripting.
                </p>

                <h2>Education</h2>
                <p>
                    I attended <a href="https://marquette.edu">Marquette University</a> in Milwaukee, WI for my
                    bachelor's degree in Computer Science and my master's in Computing.
                </p>
                <p>
                    During the summer of 2019, I was an undergraduate research assistant with the {" "}
                    <a href="https://www.marquette.edu/computer-science/research-laboratories.php">Systems Lab</a>.
                </p>
                <p>
