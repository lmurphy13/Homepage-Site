            ...
            <div className="page-content">
                ...
                <div className="project-article-container">
                    <div className="project-article-card">
                        <span className="project-article-card-title">2024 Linux PC Build</span>
                        <p className="project-article-card-desc">
                            My latest PC build. I'm running Fedora 39 on an Intel i9 with two graphics cards.
                            One is configured for PCI passthrough to a QEMU/KVM VM running Windows 11 for gaming.
                        </p>
                    ...
                    <div className="project-article-card">
                        ...
                        <p className="project-article-card-desc">
                            Written in C, LBASIC is a simple, compiled language with syntax inspired by C and BASIC. This project is in
                            semi-active development. I come back to it every few months.
                        </p>
